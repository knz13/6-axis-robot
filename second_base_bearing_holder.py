...
def main():
    ...
    triangle = create_centered_triangle(triangle_sides, bases_distance + top_side_height, "Triangle")
    ...
    cylinder = create_hollow_cylinder(base_cylinder_radius + 1, 1,bases_distance - triangle_height + bearing_outer_radius/3, (0,0,triangle_height))
    ...
    triangle = make_hole(triangle, bearing_inner_radius*2, HOLE_INF, (0,0,bases_distance  + bearing_outer_radius),through_hole=True,hole_rotation=[(0,90,0),(90,0,0)])
