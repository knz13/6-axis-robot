...
def main():
    ...
    for i in range(8):
        ...
        arm_cylinder = make_hole(arm_cylinder, m5_head_size*2, hole_height, (x,y,0),hole_rotation=(0,0,0))
        ...
        extra_cut = create_centered_rectangle(m5_head_size, m5_head_size*2, hole_height)
