...
def create_joint_motor_holder(base_cylinder):
    ...
    for i in range(2):
        ...
        for j in range(2):
            ...
            base_cylinder = make_hole(base_cylinder, m5_size*2, HOLE_INF, ((lerp([0,1],[-1,1])(i)) * (joint_motor_holder_width_for_base/2 + side_bar_width/2) , side_bar_length/2 + joint_motor_holder_current_position + (lerp([0,1],[-1,1])(j)) * side_bar_hole_distance_from_center, first_joint_base_initial_height + base_cylinder_height),through_hole=True)
        
        
        
        side_bar.Placement = App.Placement(App.Vector((lerp([0,1],[-1,1])(i)) * (joint_motor_holder_width_for_base/2 + side_bar_width/2) , side_bar_length/2, first_joint_base_initial_height + base_cylinder_height), App.Rotation(App.Vector(0,0,1),0))
...
def first_joint_shaft_holder(base_cylinder):
    ...
    joint_shaft_holder.Placement = App.Placement(App.Vector(0, joint_shaft_holder_initial_position, first_joint_base_initial_height + base_cylinder_height), App.Rotation(App.Vector(0,0,1),-90))

    # now for the motor shaft hole
        
    shaft_hole_radius = bearing_outer_radius
        
    joint_shaft_holder = make_hole(joint_shaft_holder, shaft_hole_radius*2, HOLE_INF, (0,0,first_joint_base_initial_height + joint_motor_holder_height / 2 + base_cylinder_height),through_hole=True,hole_rotation=[(0,90,0),(90,0,0)])
    ...
    joint_shaft_holder_extra_material_behind_bearing.Placement = App.Placement(App.Vector(0, joint_shaft_holder_initial_position + 13, first_joint_base_initial_height + base_cylinder_height), App.Rotation(App.Vector(0,0,1),90))
    ...
    for i in range(2):
        ...
        for j in range(2):
            ...
            base_cylinder = make_hole(base_cylinder, m5_size*2, HOLE_INF, ((lerp([0,1],[-1,1])(i)) * (joint_motor_holder_width_for_base/2 + side_bar_width/2) , -side_bar_length/2 - joint_shaft_holder_current_position - (lerp([0,1],[-1,1])(j)) * side_bar_hole_distance_from_center, first_joint_base_initial_height + base_cylinder_height + joint_motor_holder_height),through_hole=True)
    ...
    return joint_shaft_holder,base_cylinder
...
def main():
    ...
    base_cylinder = create_cylinder(base_cylinder_height, base_cylinder_radius, (0,0,first_joint_base_initial_height))
    ...
    joint_shaft_holder,base_cylinder = first_joint_shaft_holder(base_cylinder)
