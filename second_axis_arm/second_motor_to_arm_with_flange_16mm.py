...
def main():
    ...
    flange_hole_diameter = 32
    flange_holes_distance = 25/2
    flange_inner_holes_size = 4 + tolerance
    middle_section_width = 40

    half_cylinder = make_hole(half_cylinder, flange_hole_diameter, arm_cylinder_radius - middle_section_width/2, (arm_cylinder_radius - (arm_cylinder_radius - middle_section_width/2),0, arm_cylinder_height + half_cylinder_radius),hole_rotation=[(0,90,0)])
    ...
    for i in range(flange_number_of_holes):
            ...
            half_cylinder = make_hole(half_cylinder, flange_inner_holes_size, HOLE_INF, (0,x, arm_cylinder_height + half_cylinder_radius + y),hole_rotation=[(0,90,0)],through_hole=True)
